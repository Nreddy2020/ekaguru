...
.from-\[\#8EC5FC\] {
  --tw-gradient-from: #8EC5FC var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(142 197 252 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-\[\#E0F2FE\] {
...
.from-\[\#FFDEE9\] {
  --tw-gradient-from: #FFDEE9 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(255 222 233 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-black\/80 {
...
.via-\[\#B5FFFC\] {
  --tw-gradient-to: rgb(181 255 252 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #B5FFFC var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-\[\#E0C3FC\] {
  --tw-gradient-to: rgb(224 195 252 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #E0C3FC var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-\[\#FFF1F2\] {
...
.to-\[\#8EC5FC\] {
  --tw-gradient-to: #8EC5FC var(--tw-gradient-to-position);
}
.to-\[\#D4FC79\] {
  --tw-gradient-to: #D4FC79 var(--tw-gradient-to-position);
}
.to-\[\#DCFCE7\] {
...
.shadow-\[0_0_20px_rgba\(234\2c 179\2c 8\2c 0\.5\)\] {
  --tw-shadow: 0 0 20px rgba(234,179,8,0.5);
...
.hover\:shadow-\[0_0_40px_rgba\(255\2c 255\2c 255\2c 0\.5\)\]:hover {
  --tw-shadow: 0 0 40px rgba(255,255,255,0.5);
