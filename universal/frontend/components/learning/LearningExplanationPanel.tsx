...
export function LearningExplanationPanel({
  ...
  const [viewMode, setViewMode] = useState<'LEARNER' | 'STUDIO'>('LEARNER');
  ...
  return (
    ...
    >
      {/* 1. Header: Child-Friendly Learning Companion + Teacher/Studio Switcher */}
      <div className="px-5 py-3.5 border-b border-slate-800 bg-slate-950/90 flex items-center justify-between flex-wrap gap-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-medium px-2 py-0.5 rounded-full bg-rose-500/10 text-rose-300 border border-rose-500/20">
                Class 5 Science
              </span>
            </div>
        ...
        {/* View Mode Toggle: Learner Journey vs Studio Inspector */}
      ...
      {/* 2. Studio Mode Banner (Only when in studio inspection mode) */}
      {viewMode === 'STUDIO' && (
      ...
      {/* 3. Main Interactive Workspace Container */}
      <div className="flex-1 p-5 flex flex-col gap-5 overflow-y-auto max-h-[720px]">
        ...
        {/* Misconception Remediation (Warm & Empathetic Socratic Fix) */}
        ...
        {/* Active Socratic Step (Learner Friendly) */}
        ...
        {/* 🫀 Experiential Observation Experiment (Engine D UX) */}
      ...
      {/* 4. Child-Friendly Mastery Journey Footer */}
