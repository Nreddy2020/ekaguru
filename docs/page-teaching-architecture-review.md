...
- Add durable queued OCR/model work, cancellation, distributed cache, per-user budgets and load tests before broad deployment. Current inference is synchronous and cached/coalesced per process.
